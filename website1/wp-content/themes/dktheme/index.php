    ...
    <section class="banner-area relative">
        <div class="container">
            <div class="row fullscreen align-items-center justify-content-center">
                <div class="banner-left col-lg-6"><img class="d-flex mx-auto img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/header-img.png" alt="" /></div>
                <div class="col-lg-6">
                    <div class="story-content">
                        <h6 class="text-uppercase">From the for User interface</h6>
                        <h1>Behind Every <span class="sp-1">Success</span>
                            There is a <span class="sp-2">Cactus</span></h1>
                        <a class="genric-btn primary circle arrow" href="#">Get Started</a>
    ...
    <section class="video-area pt-40 pb-40">
        ...
        <div class="container">
            <div class="video-content">
                <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn"><img src="<?php echo get_template_directory_uri(); ?>/img/play-btn.png" alt=""></a>
    ...
    <section class="about-area pt-100 pb-100">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid d-flex mx-auto" src="<?php echo get_template_directory_uri(); ?>/img/about.png" alt="">
                </div>
            </div>
        </div>
    </section>
